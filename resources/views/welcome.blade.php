...
{{-- <div>
    <footer><p> md zaman copy right by 2023</p></footer>
</div> --}}

    </body>
    {{-- <img src="images/md4.jpg" alt=""> --}}
    <img src="{{ asset('images/md1.jpg') }}" alt="">
</html>
